          ...
          <div className="row g-4">
            <div className="col-md-4">
              <div className="p-4 shadow-sm bg-white rounded-4 h-100">
                ...
                <p className="text-muted">Your food delivered hot and fresh in record time!</p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="p-4 shadow-sm bg-white rounded-4 h-100">
                ...
                <p className="text-muted">We partner with the best restaurants in town.</p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="p-4 shadow-sm bg-white rounded-4 h-100">
                ...
                <p className="text-muted">Order food in just a few taps from your phone.</p>
              </div>
            </div>
          </div>
        </div>
